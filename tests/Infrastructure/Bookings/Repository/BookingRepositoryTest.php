...
class BookingRepositoryTest extends TestCase
{
    ...
    public function testGetAll(): void
    {
        ...
        $statementMock->method('fetchAll')->willReturn(
            [
                ["event_id" => 1,"user_id" => 1,"start_at" => '2024-08-11 12:45',"end_at" => '2024-08-11 13:45',"id" => 1, "first_name" => "test", "last_name" => "test-last", "cell_number" => "0293902839", "email" => "test@gmail.com", "id" => "1", "details_id" => "2", "booker_id" => "1", 'created_at' => '1712340841', "event_name" => "test"],
                ["event_id" => 1,"user_id" => 1,"start_at" => '2024-09-11 12:45',"end_at" => '2024-09-11 13:45',"id" => 2, "first_name" => "test", "last_name" => "test-last", "cell_number" => "0293902839", "email" => "test@gmail.com", "id" => "2", "details_id" => "3", "booker_id" => "1", 'created_at' => '1712340841', "event_name" => "test"],
                ["event_id" => 1,"user_id" => 1,"start_at" => '2024-10-11 12:45',"end_at" => '2024-10-11 13:45',"id" => 3, "first_name" => "test", "last_name" => "test-last", "cell_number" => "0293902839", "email" => "test@gmail.com", "id" => "3", "details_id" => "4", "booker_id" => "1", 'created_at' => '1712340841', "event_name" => "test"],
            ]
        );
